...
/**
 * \file    core/triggers/interface_99_modPeppol_PeppolTriggers.class.php
 * \ingroup peppol
 ...
 *      - interface_99_modPeppol_MyTrigger.class.php
...
dol_include_once('/peppolpeppyrus/backport/v16/core/class/html.formsetup.class.php');

/**
 *  Class of triggers for Peppol module
 */
class InterfacePeppolTriggers extends DolibarrTriggers
{
	/**
	 * Constructor
	 *
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "Peppol triggers.";
	...
	{
		if (!isModEnabled('peppolpeppyrus')) {
		...
		switch ($action) {
			...
			case 'ECMFILES_MODIFY':
				if (empty($conf->global->PEPPOL_USE_TRIGGER)) {
					dol_syslog("Trigger Peppol is not enabled into module setup");
					return 0;
				}
				...
				dol_syslog("Trigger peppol ".json_encode($object));
				break;
