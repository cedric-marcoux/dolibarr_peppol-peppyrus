...
dol_include_once('/peppolpeppyrus/class/myobject.class.php');
dol_include_once('/peppolpeppyrus/lib/peppol_myobject.lib.php');

// Load translation files required by the page
$langs->loadLangs(array("peppol@peppolpeppyrus", "companies", "other", "mails"));
...
//$result = restrictedArea($user, 'peppolpeppyrus', $object->id);

$permission = $user->rights->peppolpeppyrus->myobject->write;
...
if ($object->id) {
	...
	$linkback = '<a href="'.dol_buildpath('/peppolpeppyrus/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
